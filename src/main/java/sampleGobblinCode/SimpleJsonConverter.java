...
public class SimpleJsonConverter extends ToAvroBaseConverter<String, String> {
    ...
    @Override
    public Schema convertSchema(String inputSchema, WorkUnitState workUnitState)
        throws SchemaConversionException {
        return new Schema.Parser().parse(inputSchema);
    }

    @Override
    public Iterable<GenericRecord> convertRecord(Schema schema, String inputRecord, WorkUnitState workUnitState)
